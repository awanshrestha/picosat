    ...
    return (
      <div>
        ...
        <div className="agraph-info">
          ...
          <br />
          <p>Below is the real time plot of temperature from PicoSat.</p>
        </div> <br /><br />
        ...
        <div className="agraph-info">
          ...
          <br />
          <p>Below is the real time plot of humidity from PicoSat.</p>
        </div> <br /><br />
        <div style={{ width: "700px", minHeight: "300px", margin: "0 auto" }}>
          <div className="agraph-outer-wrapper">
        ...
        <div className="agraph-info">
          ...
          <br />
          <p>Below is the real time plot of pressure from PicoSat.</p>
        </div> <br /><br />
        <div style={{ width: "700px", minHeight: "300px", margin: "0 auto" }}>
          <div className="agraph-outer-wrapper">
